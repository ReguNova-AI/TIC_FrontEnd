  ...
  return (
    <>
      ...
      <Modal
        ...
        footer={null}
        width={(modalContent.action === "Create" && modalContent?.tab?.title === "Sectors" || modalContent.action === "Create" && modalContent?.tab?.title === "Industries") ? 400 :  modalContent.action === "Create" && modalContent?.tab?.title === "Roles"  ? 800 :600}
      > 
