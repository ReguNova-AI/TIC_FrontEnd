...
export default function Profile() {
  ...
  return (
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      <Grid item>
                        <Stack direction="row" spacing={1.25} alignItems="center">
                          ...
                          <Stack>
                            <Typography variant="h6"> {userdetails[0]?.user_first_name} {userdetails[0]?.user_last_name}</Typography>
                      ...
                      <Grid item>
                        <Tooltip title="Logout">
                          <IconButton size="large" sx={{ color: 'text.primary' }} onClick={(event) => handleListItemClick(3,'logout')}>
                            <LogoutOutlined />
                          </IconButton>
                        </Tooltip>
                      </Grid>
      ...
      <ListItemButton selected={selectedIndex === 2} onClick={(event) => handleListItemClick(2,'/apps')}>
        <ListItemIcon>
          <QuestionCircleOutlined />
        </ListItemIcon>
        <ListItemText primary="Support" />
      </ListItemButton>
      <ListItemButton selected={selectedIndex === 3} onClick={(event) => handleListItemClick(3,'logout')}>
        <ListItemIcon>
          <LogoutOutlined />
        </ListItemIcon>
