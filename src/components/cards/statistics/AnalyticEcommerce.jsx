...
// assets
import {RiseOutlined , FallOutlined ,HistoryOutlined,FileTextOutlined} from '@ant-design/icons';
import { Avatar } from '@mui/material';

const iconSX = { fontSize: '0.75rem', color: 'inherit', marginLeft: 0, marginRight: 0 };

export default function AnalyticEcommerce({ color = 'primary', title, count, percentage, isLoss, extra,graphic }) {
  ...
  return (
    <MainCard contentSX={{ p: 2.25 }} style={{ boxShadow: '6px 12px 20px #e4e4e4', position: 'relative' }}>
      <Stack spacing={0.5}>
